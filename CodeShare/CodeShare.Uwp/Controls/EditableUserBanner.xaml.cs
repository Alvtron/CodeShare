...
{
    public sealed partial class EditableUserBanner : UserControl
    {
        public static new readonly DependencyProperty ContentProperty = DependencyProperty.Register("User", typeof(User), typeof(EditableUserBanner), new PropertyMetadata(default(User)));
        ...
        private static new readonly DependencyProperty WidthProperty = DependencyProperty.Register("Width", typeof(int), typeof(EditableUserBanner), new PropertyMetadata(800));
        private static new readonly DependencyProperty HeightProperty = DependencyProperty.Register("Height", typeof(int), typeof(EditableUserBanner), new PropertyMetadata(320));
        ...
        public async Task CropImageAsync()
        {
            ...
            var dialog = new BannerCroppingDialog(User.Banner);
        ...
        public async Task EditImagesAsync()
        {
            ...
            var dialog = new UserBannersManagerDialog(User.Banners, $"{User.Name} - Profile Banners");
            await dialog.ShowAsync();
