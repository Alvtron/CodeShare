...
{
    public class UserViewModel : ContentPageViewModel
    {
        private User _user;
        public User User
        {
            ...
            set
            {
                ...
                IsUserAuthor = value.Equals(AuthService.CurrentUser);
            }
        }
        ...
        {
            if (!(await RestApiService<User>.Get(User.Uid) is User user)) return false;
        ...
        public override async Task ReportAsync()
        {
            ...
            var reportDialog = new ReportDialog(User.Name);
