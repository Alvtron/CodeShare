...
{
    public sealed partial class CodeBannersManagerDialog : ContentDialog
    {
        private ImageManager<CodeBanner> ImageManager { get; }

        public CodeBannersManagerDialog(ObservableCollection<CodeBanner> banners, string dialogTitle)
        {
            ImageManager = new ImageManager<CodeBanner>(banners);
            InitializeComponent();
