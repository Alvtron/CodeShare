...
namespace CodeShare.DataAccess
{
    public class DataContext : DbContext
    {
        ...
        {
            Debug.WriteLine($"CodeShare.DataAccess: Initializing context...");

            Configuration.ProxyCreationEnabled = false;

            Database.SetInitializer(new DataInitializer());

            Debug.WriteLine($"CodeShare.DataAccess: Connection configured with connection string: {Database.Connection.ConnectionString}.");
        }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            Debug.WriteLine($"CodeShare.DataAccess: Creating model for Context...");
            ...
            Debug.WriteLine($"CodeShare.DataAccess: Creating model for {typeof(Content).Name} class.");
            ...
            Debug.WriteLine($"CodeShare.DataAccess: Creating model for {typeof(Comment).Name} class.");
            ...
            Debug.WriteLine($"CodeShare.DataAccess: Creating model for {typeof(Reply).Name} class.");
            ...
            Debug.WriteLine("CodeShare.DataAccess: Model creating completed.");
        }
    }
}
