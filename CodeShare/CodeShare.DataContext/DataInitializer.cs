...
namespace CodeShare.DataAccess
{
    public class DataInitializer : DropCreateDatabaseIfModelChanges<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"CodeShare.DataAccess: Deleting all files in FTP directory.");
            FtpService.DeleteAll();

            System.Diagnostics.Debug.WriteLine($"CodeShare.DataAccess: Seeding database at {context.Database.Connection.ConnectionString}...");
            base.Seed(context);

            System.Diagnostics.Debug.WriteLine($"CodeShare.DataAccess: Adding dummy-data to database.");
            ...
            context.SaveChanges();
            System.Diagnostics.Debug.WriteLine("Seeding database completed.");
        }
        ...
        public static byte[] FileToByteArray(string filePath)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("CodeShare.DataAccess: FileToByteArray: Provided path was empty.");
                return null;
            }
            ...
            {
                System.Diagnostics.Debug.WriteLine($"CodeShare.DataAccess: FileToString: {e.Message}");
                return null;
            }
        }
        ...
        public static string FileToString(string filePath)
        {
            if (string.IsNullOrWhiteSpace(filePath))
            {
                System.Diagnostics.Debug.WriteLine("CodeShare.DataAccess: FileToString: Provided path was empty.");
                return null;
            }
